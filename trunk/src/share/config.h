...
#else
#define AUDIO_BUFF_HI 1024
#define AUDIO_BUFF_LO 512
#endif
...
#define DEFAULT_KEY_CAMERA_R         SDLK_BACKSPACE
#define DEFAULT_KEY_CAMERA_L         SDLK_TAB
